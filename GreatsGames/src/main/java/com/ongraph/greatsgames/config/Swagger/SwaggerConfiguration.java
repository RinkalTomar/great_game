package com.ongraph.greatsgames.config.Swagger;
...
*/
    ...
    public Docket greatsgamesApi() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                       .select().apis(RequestHandlerSelectors.basePackage("com.ongraph.greatsgames"))
    ...
    private ApiInfo apiInfo() {
        ...
        return new ApiInfo(
                "Great Games REST APIs",
                "REST APIs developed for Great Games Management Console" +
                        ", Developed by Amit Agarwal",
                "1.0",
                "Terms of service",
                new Contact("Federico Pereira",
                        "www.example.com",
                        "Federico@greatsgames.com"),
                "Copyright 2017 - 2018 GreatGames, All rights reserved.",
                " ",

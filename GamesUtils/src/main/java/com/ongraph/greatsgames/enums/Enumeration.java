package com.ongraph.greatsgames.enums;
...
public class Enumeration {
    ...
    public enum EmailSubjects implements GenericEnum {
        ...
        INVITATION_EMAIL("GreatGames - You are invited to GreatGames CMS, Please create your Account"),
        VERIFICATION_EMAIL("GreatGames - Verify your Email"),
        PASSWORD_RESET_EMAIL("GreatGames - Password Reset Request");

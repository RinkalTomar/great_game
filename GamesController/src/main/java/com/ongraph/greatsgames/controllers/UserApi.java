...
@Api(value = "User", description = "GreatGames Users API", tags = {"Users"})
public interface UserApi {

    @ApiOperation(value = "Add/Update a new User in the GreatGames Applicaiton", nickname = "AddOrEditUser", notes = "Returns HTTP 201 if user is successfully created",
    ...
    @PostMapping(value = "users/resend/verification",
    produces = {"application/json"},
    consumes = {"application/json"})
    ResponseEntity<AbstractResponseBean> resendActivationOrPasswordResetLink(@RequestBody(required = true) List<UserAcountResetOrActivateRequest> userAcountResetOrActivateRequests) throws Exception;
